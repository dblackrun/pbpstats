...
class TestDataScheduleLoader:
    ...
    def test_file_loader_loads_data(self):
        ...
        schedule_loader = DataNbaScheduleLoader(self.league, self.season, season_type, source, self.data_directory)
    ...
    def test_web_loader_loads_data(self):
        with open(f'{self.data_directory}/schedule/data_{self.league}_{self.season}.json') as f:
