...
def test_data_made_free_throw():
    item = {'evt': 110, 'cl': '01:09', 'de': "[NYK 17-27] O'Quinn Free Throw 2 of 2 (3 PTS)", 'locX': 0, 'locY': -80, 'mtype': 12, 'etype': 3, 'opid': '', 'tid': 1610612752, 'pid': 203124, 'hs': 17, 'vs': 27, 'epid': '', 'oftid': 1610612752}
    period = 1
    game_id = '0021900001'
...
def test_data_missed_free_throw():
    item = {'evt': 108, 'cl': '01:09', 'de': "[NYK] O'Quinn Free Throw 1 of 2 Missed", 'locX': 0, 'locY': -80, 'mtype': 11, 'etype': 3, 'opid': '', 'tid': 1610612752, 'pid': 203124, 'hs': 16, 'vs': 27, 'epid': '', 'oftid': 1610612752}
    period = 1
    game_id = '0021900001'
    event = DataFreeThrow(item, period, game_id)
...
def test_away_from_play_true():
    foul = {'EVENTMSGTYPE': 6, 'EVENTMSGACTIONTYPE': 6, 'VISITORDESCRIPTION': 'Away From Play Foul', 'PCTIMESTRING': '0:45', 'PLAYER1_TEAM_ID': 2, 'PLAYER1_ID': 2, 'PLAYER2_ID': 1}
    order = 1
    ...
    make = {'EVENTMSGTYPE': 1, 'EVENTMSGACTIONTYPE': 10, 'VISITORDESCRIPTION': 'Made Shot by team that got fouled', 'PCTIMESTRING': '0:35', 'PLAYER1_TEAM_ID': 1, 'PLAYER1_ID': 21}
    order = 1
...
def test_foul_on_made_shot_by_team_that_got_fouled_is_not_away_from_play_ft():
    ...
    order = 1
    foul_event = StatsFoul(foul, order)
    make = {'EVENTMSGTYPE': 1, 'EVENTMSGACTIONTYPE': 10, 'HOMEDESCRIPTION': 'Made Shot by team that got fouled', 'PCTIMESTRING': '0:45', 'PLAYER1_TEAM_ID': 1, 'PLAYER1_ID': 2}
    order = 1
    make_event = StatsFieldGoal(make, order)
...
def test_foul_on_made_shot_by_team_that_didnt_get_fouled_is_away_from_play_ft():
    ...
    order = 1
    foul_event = StatsFoul(foul, order)
    make = {'EVENTMSGTYPE': 1, 'EVENTMSGACTIONTYPE': 10, 'HOMEDESCRIPTION': 'Made Shot by team that got fouled', 'PCTIMESTRING': '0:45', 'PLAYER1_TEAM_ID': 2, 'PLAYER1_ID': 3}
    order = 1
    make_event = StatsFieldGoal(make, order)
    ft_event.previous_event = None
    ft_event.next_event = foul_event
...
def test_foul_on_made_ft_by_team_that_didnt_get_fouled_is_away_from_play_ft():
    ft_2_of_2 = {'EVENTNUM': 607, 'PCTIMESTRING': '0:25', 'VISITORDESCRIPTION': 'Jackson Free Throw 2 of 2 (16 PTS)', 'EVENTMSGACTIONTYPE': 12, 'EVENTMSGTYPE': 3, 'PLAYER1_ID': 202704, 'PLAYER1_TEAM_ID': 1610612765, 'PLAYER2_ID': None, 'PLAYER2_TEAM_ID': None, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    ft_2_of_2_event = StatsFreeThrow(ft_2_of_2, order)
    foul = {'EVENTNUM': 609, 'PCTIMESTRING': '0:25', 'VISITORDESCRIPTION': 'Griffin AWAY.FROM.PLAY.FOUL (P5.PN) (M.Davis)', 'EVENTMSGACTIONTYPE': 6, 'EVENTMSGTYPE': 6, 'PLAYER1_ID': 201933, 'PLAYER1_TEAM_ID': 1610612765, 'PLAYER2_ID': 201145, 'PLAYER2_TEAM_ID': 1610612764, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    foul_event = StatsFoul(foul, order)
    ft_1_of_1 = {'EVENTNUM': 611, 'PCTIMESTRING': '0:25', 'HOMEDESCRIPTION': 'Beal Free Throw 1 of 1 (32 PTS)', 'EVENTMSGACTIONTYPE': 10, 'EVENTMSGTYPE': 3, 'PLAYER1_ID': 203078, 'PLAYER1_TEAM_ID': 1610612764, 'PLAYER2_ID': None, 'PLAYER2_TEAM_ID': None, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    ft_1_of_1_event = StatsFreeThrow(ft_1_of_1, order)
    fg = {'EVENTNUM': 612, 'PCTIMESTRING': '0:24', 'VISITORDESCRIPTION': "MISS Green 27' 3PT Jump Shot", 'EVENTMSGACTIONTYPE': 1, 'EVENTMSGTYPE': 2, 'PLAYER1_ID': 201145, 'PLAYER1_TEAM_ID': 1610612764, 'PLAYER2_ID': None, 'PLAYER2_TEAM_ID': None, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
...
def test_inbound_foul_ft_true():
    foul = {'EVENTMSGTYPE': 6, 'EVENTMSGACTIONTYPE': 5, 'VISITORDESCRIPTION': 'Inbound Foul', 'PCTIMESTRING': '0:45', 'PLAYER1_TEAM_ID': 2}
    order = 1
    foul_event = StatsFoul(foul, order)
    ft = {'EVENTMSGTYPE': 3, 'EVENTMSGACTIONTYPE': 10, 'HOMEDESCRIPTION': 'Free Throw 1 of 1', 'PCTIMESTRING': '0:45', 'PLAYER1_TEAM_ID': 1}
    order = 1
    ft_event = StatsFreeThrow(ft, order)
    foul_event.previous_event = None
    foul_event.next_event = ft_event
...
def test_flagrant_free_throw_type():
    foul = {'EVENTNUM': 609, 'PCTIMESTRING': '0:25', 'VISITORDESCRIPTION': 'Griffin Flagrant Foul (P5.PN) (M.Davis)', 'EVENTMSGACTIONTYPE': 14, 'EVENTMSGTYPE': 6, 'PLAYER1_ID': 201933, 'PLAYER1_TEAM_ID': 1610612765, 'PLAYER2_ID': 203078, 'PLAYER2_TEAM_ID': 1610612764, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    foul_event = StatsFoul(foul, order)
    ft_1_of_1 = {'EVENTNUM': 611, 'PCTIMESTRING': '0:25', 'HOMEDESCRIPTION': 'Beal Free Throw Flagrant (32 PTS)', 'EVENTMSGACTIONTYPE': 11, 'EVENTMSGTYPE': 3, 'PLAYER1_ID': 203078, 'PLAYER1_TEAM_ID': 1610612764, 'PLAYER2_ID': None, 'PLAYER2_TEAM_ID': None, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    ft_1_of_1_event = StatsFreeThrow(ft_1_of_1, order)
    ft_2_of_2 = {'EVENTNUM': 611, 'PCTIMESTRING': '0:25', 'HOMEDESCRIPTION': 'Beal Free Throw Flagrant (32 PTS)', 'EVENTMSGACTIONTYPE': 12, 'EVENTMSGTYPE': 3, 'PLAYER1_ID': 203078, 'PLAYER1_TEAM_ID': 1610612764, 'PLAYER2_ID': None, 'PLAYER2_TEAM_ID': None, 'PLAYER3_ID': None, 'PLAYER3_TEAM_ID': None}
    order = 1
    ft_2_of_2_event = StatsFreeThrow(ft_2_of_2, order)
