...
class Turnover(object):
    ...
    def is_lost_ball_out_of_bounds(self):
        ...
        return self.event_action_type == 40 or (self.event_action_type == 2 and not self.is_steal)

    @property
    def is_bad_pass_out_of_bounds(self):
        # some labelled as bad pass but should be bad pass out of bounds (missing player3 id)
        return self.event_action_type == 45 or (self.event_action_type == 1 and not self.is_steal)
